...
<div id="header-row">
        ...
        <div class="row">
                ...
                <div class="blog-post">
                    ...
                    <div class="postmetadata">
                        <a name="middle">
                            <ul>
                                <li>
                                    Độ khó - Dễ Độ khó - Trung bình Độ khó - Khó
                                </li>
                            </ul>
                        </a>
                    </div>
                    <img src="" style="width: 300px; height: 150px;">
                    <p>Directions: In this part, you will read a selection of business letters. Each text is followed by several questions. Select the best answer for each question by clicking on the answer you want to choose.</p>
                </div>
            ...
            <div class="span9" style="text-align: left">
                ...
                <div class="span9" style="text-align: center">
                    ...
                    <a class="btn btn-success hidden" id="btnBaiThiKhac" href="/webtoeic/reading">Làm bài thi khác</a>
                </div>
    ...
    <script src="../../resources/js/client/baiDoc/lamBaiDocPart7.js"></script>
</body>
