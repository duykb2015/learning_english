	...
	<div class="container">
		...
		<div class="span9" style="text-align: center">
			<div class="page-header">
				<h4 style="font-weight: bold;">DANH SÁCH BÀI THI NGHE</h4>
			</div>
		</div>
		<div class="span3">
			<div class="navbar  pull-right">
					<div>
							<input type="text" class="form-control" id="searchGrammar"
								placeholder="Tìm kiếm bài thi nghe..."
					...
					<div class="span9">
						<div class="span3">
							<img class="imageGrammar"
								src="<?=base_url()?>resources/file/images/grammar/26.thi_htht_anhngumshoa.jpg" />
